...
////////////////////////
		if(File.fs ==="Windows"){
			var dlgTitle="Corner Edit";
		}else{
			var dlgTitle="Corner Editor";
		}
        var dlg = new Window('dialog{alignChildren: "left"}', dlgTitle);
		...
		helpButton.onClick =function (){
			var hdlg = new Window('dialog{alignChildren: "left"}', 'Corner Editor Help');
			helpText=hdlg.add ('statictext',undefined,"test\ntest",{multiline:true});
			helpText.size = [500, 460];
		...
		try{
			...
			var b1=modes.add("button",undefined,"Round")
			var b2=modes.add("button",undefined,"Inverse Round")
			var b3=modes.add("button",undefined,"Chamfer")
			var b4=modes.add("button",undefined,"Inset")
